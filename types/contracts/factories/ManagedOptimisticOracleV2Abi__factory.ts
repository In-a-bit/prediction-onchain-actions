...
import type {
  ManagedOptimisticOracleV2Abi,
  ManagedOptimisticOracleV2AbiInterface,
} from "../ManagedOptimisticOracleV2Abi";
    ...
    inputs: [
      {
        indexed: false,
        internalType: "uint256",
        name: "newMinimumLiveness",
        type: "uint256",
      },
    ],
    name: "MinimumLivenessUpdated",
    type: "event",
  },
  {
    anonymous: false,
...
export class ManagedOptimisticOracleV2Abi__factory {
  static readonly abi = _abi;
  static createInterface(): ManagedOptimisticOracleV2AbiInterface {
    return new Interface(_abi) as ManagedOptimisticOracleV2AbiInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ManagedOptimisticOracleV2Abi;
  }
}
