...
import type { CTFExchange, CTFExchangeInterface } from "../CTFExchange";
...
export class CTFExchange__factory {
  static readonly abi = _abi;
  static createInterface(): CTFExchangeInterface {
    return new Interface(_abi) as CTFExchangeInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): CTFExchange {
    return new Contract(address, _abi, runner) as unknown as CTFExchange;
  }
}
